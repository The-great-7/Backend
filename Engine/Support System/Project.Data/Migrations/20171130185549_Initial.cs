        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssignmentId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AssignmentName = table.Column<string>(maxLength: 70, nullable: false),
                    CourseId = table.Column<int>(nullable: false),
                    StudentAssignmentId = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssignmentId = table.Column<int>(nullable: false),
                    StudentId = table.Column<int>(nullable: false),
                    DueDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2017, 12, 7, 20, 55, 49, 726, DateTimeKind.Local)),
