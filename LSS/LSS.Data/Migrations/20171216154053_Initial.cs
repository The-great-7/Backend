        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2017, 12, 23, 17, 40, 52, 642, DateTimeKind.Local)),
                    Name = table.Column<string>(maxLength: 70, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAssignment", x => new { x.AssignmentId, x.StudentId });
                    table.ForeignKey(
